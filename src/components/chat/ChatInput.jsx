...
import { Send, Mic, X, Check, Square, Ellipsis } from "lucide-react";
...
export default function ChatInput({
    ...
    const isDisabled = isSubmitting || isListening;

    return (
        <motion.div
            layout
            className={clsx(
                "relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border transition-all max-w-4xl mx-auto",
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <div className="inline-flex shrink-0 justify-center items-center size-8 rounded-lg text-gray-500 hover:bg-gray-100 focus:z-10 dark:hover:bg-neutral-800">
                            ...
                            >
                                <div className="space-y-3 mb-2">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-600 font-medium">{temperature.toFixed(2)}</span>
                                    </div>
                                    <Slider
                                        value={[temperature]}
                                ...
                                <div className="space-y-3 mb-2">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-600 font-medium">{topP.toFixed(2)}</span>
                                    </div>
                                    <Slider
                                        value={[topP]}
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-600 font-medium">{maxTokens}</span>
                                    </div>
                                    <Slider
                                        value={[maxTokens]}
                        ...
                        {!isListening ? (
                            <>
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <motion.button
                                                ...
                                                className="inline-flex justify-center items-center size-8 rounded-lg text-gray-500 border border-transparent disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100 dark:hover:bg-neutral-800"
                                ...
                                <button
                                    ...
                                    disabled={!message}
                                    className={clsx(
                                        "flex shrink-0 justify-center items-center gap-x-2 text-white py-2 px-4 text-sm font-medium rounded-sm disabled:opacity-50 disabled:pointer-events-none bg-[#6466ee] hover:bg-[#5759e6] transition",
                                        isSubmitting && "opacity-70 cursor-not-allowed"
                                    )}
                                >
                                    {isSubmitting ? "Sending..." : "Send"}
                                    {isSubmitting ? (
                                        <Square className="size-4 stroke-gray-800 fill-gray-800" />
                                    ) : (
                            ...
                            <>
                                <button
                                    ...
                                    className="size-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition"
                                >
                                    <X className="size-4" />
                                </button>
                                <button
            ...
            <AnimatePresence>
                {(error || speechError) && (
                    <motion.p
                        ...
                        exit={{ opacity: 0, y: -8 }}
                        className="text-red-500 text-sm absolute -bottom-6 left-3"
                    >
                        {error || speechError}
                    </motion.p>
                )}
